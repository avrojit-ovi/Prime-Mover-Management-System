...
<!-- /Edit fuel record Modal -->
    ...
    while ($rowFuelRecord = mysqli_fetch_assoc($resultFuelRecords)) {
        ...
        <tr>
            ...
            <td><?php echo number_format($totalTaka, 2, '.', ','); ?></td> <!-- Display total taka here -->
...
<script>
     ...
     function openEditModal(id, vehicleNumber, fuelLiter, fuelRate, driverName, fuelDate) {
        
        // Populate the input fields in the edit modal
        document.getElementById('editFuelId').value = id;
        document.getElementById('editVehicleNo').value = vehicleNumber;
        document.getElementById('editFuelLiter').value = fuelLiter;
        document.getElementById('editFuelRate').value = fuelRate;
        document.getElementById('editDriverName').value = driverName;
        document.getElementById('editFuelDate').value = fuelDate;
